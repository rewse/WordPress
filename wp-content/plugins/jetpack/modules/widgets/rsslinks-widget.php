...
class Jetpack_RSS_Links_Widget extends WP_Widget {
	...
	function _rss_link( $type = 'posts', $args ) {
      ...
      $link_item = '<a href="' . get_bloginfo($rss_type) . '" title="' . esc_attr( $subscribe_to ) . '"><img src="' . esc_url( plugins_url( 'images/rss/' . $args['imagecolor'] . '-' . $args['imagesize'] . '@2x.png', dirname( dirname( __FILE__ ) ) ) ) . '" alt="RSS Feed" width="14px" height="14px" /></a>';
